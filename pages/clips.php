...
<title>Clips — NVR Community Hub</title>
...
<main class="hub-main" style="padding:24px">
  <section class="card section-gap">
    <h1 class="sec-title">Clips</h1>
    <p style="color:var(--muted);margin-top:16px">Página de clips em construção. Os endpoints do backend PHP estão agora disponíveis em /api.</p>
  </section>
</main>
