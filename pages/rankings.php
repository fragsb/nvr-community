...
<title>Rankings — NVR Community Hub</title>
...
<main class="hub-main" style="padding:24px">
  <section class="card section-gap">
    <h1 class="sec-title">Rankings</h1>
    <p style="color:var(--muted);margin-top:16px">Página de rankings em desenvolvimento. O backend PHP/API está configurado, mas esta página ainda não possui listagem dinâmica.</p>
  </section>
</main>
