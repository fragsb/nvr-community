...
<title>Notícia — NVR Community Hub</title>
...
<main class="hub-main" style="padding:24px">
  <section class="card section-gap">
    <h1 class="sec-title">Notícia</h1>
    <p style="color:var(--muted);margin-top:16px">Slug: <strong><?= htmlspecialchars($_GET['slug'] ?? 'nenhum') ?></strong></p>
    <p style="color:var(--muted);margin-top:12px">Esta página de notícia ainda não lê o conteúdo da base de dados, mas a navegação já funciona.</p>
  </section>
</main>
